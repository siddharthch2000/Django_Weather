...
def home(request):
	...
	if request.method =="POST":
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=25&API_KEY=6926D04A-354E-4840-AAC3-216B3C777A5A")
		...
		if api[0]['Category']['Name'] == "Good":
			...
			category_color = "unhealthysensitivegroup" 
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=20002&distance=25&API_KEY=6926D04A-354E-4840-AAC3-216B3C777A5A")
